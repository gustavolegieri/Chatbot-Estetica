        ...
        <form id="settings-form" onSubmit={handleSave} className="space-y-6">
          ...
          <section className="rounded-2xl border border-white/[0.075] bg-surface-850/75 p-5 shadow-[0_16px_44px_rgba(0,0,0,0.16)] sm:p-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div><label className="label">Reset de sessão (min)</label><input type="number" min={60} max={60} className="input" value={60} readOnly /><p className="mt-1 text-[11px] text-slate-500">A apresentação completa volta após 1 hora sem mensagens.</p></div>
              ...
              <div><label className="label">Confirmação antecipada (min)</label><input type="number" min={120} max={120} className="input" value={120} readOnly /><p className="mt-1 text-[11px] text-slate-500">A confirmação é solicitada cerca de 2 horas antes.</p></div>
