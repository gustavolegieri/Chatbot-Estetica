...
export const BOT_PROMPT_DEFAULTS: PromptDef[] = [
  {
    ...
    content: "Olá! Aqui é a assistente da *{businessName}* 🚗\n\nCuido do seu atendimento do início ao fim: indico o serviço certo para o seu carro, mostro o preço e reservo o horário.\n\n*Como prefere ser chamado(a)?*",
  },
  {
  ...
  },
  {
    ...
    content: "*{clientName}*, do que seu carro precisa hoje?\n\n{menu}\n\n_Pode também descrever o problema com suas palavras — eu indico o serviço._",
  },
  {
    key: "service_action_menu",
    label: "Ações após detalhe do serviço",
    category: "fluxo",
    content: "Como seguimos?\n\n*1* 📅 Agendar este serviço\n*2* ↩️ Ver outros serviços\n*3* 💬 Tirar uma dúvida\n*4* 👤 Falar com a equipe",
  },
  {
  ...
  },
  {
    ...
    category: "fluxo",
    content: "Agora me conte do carro em *uma mensagem só*:\n\n🚗 modelo e ano\n🔠 placa\n🎨 cor\n🔎 estado da pintura\n\n_Ex.: Civic 2021, placa BRA2E19, preto, bom estado._",
  },
  {
    key: "etapa4_vehicle_has",
    label: "Veículo já informado",
    category: "fluxo",
    content: "Perfeito, já tenho os dados do seu veículo. Vou montar a estimativa.",
  },
  {
    key: "etapa4_ask_year",
  ...
  },
  {
    ...
    category: "fluxo",
    content: "Não consegui identificar o veículo nessa mensagem 🤔\n\nEnvie tudo junto, do seu jeito:\n_Ex.: Civic 2021, placa BRA2E19, preto, bom estado._",
  },
  {
    key: "etapa5_quote",
  ...
  },
  {
    ...
    category: "fluxo",
    content: "📅 Escolha o dia no calendário acima.\n\n_Toque em *Ver datas* ou escreva a data, como *16/09*._",
  },
  {
    key: "etapa7_time",
    ...
    content: "*Horários de {dayLabel}*\n\nSeparo *{durationLabel}* só para o seu carro.\n\n{slots}\n\n_Toque no horário ou escreva, por exemplo, *09:00*._",
  },
  {
    key: "etapa7_no_slots",
    ...
    category: "fluxo",
    hint: "{dayLabel}",
    content: "*{dayLabel}* já está cheio 😕\n\nEscolha outro dia na lista — ou responda *9* e a equipe encaixa você.",
  },
  {
    key: "etapa8_payment",
  ...
  },
  {
    ...
    category: "fluxo",
    hint: "{menu}",
    content: "Não identifiquei essa opção 🤔 Escolha uma das alternativas:\n\n{options}",
  },
  {
    ...
    category: "automacao",
    hint: "{name}",
    content: "Olá{name}! Seu atendimento na *Garagem do Ka* continua aberto.\n\nQuando quiser retomar, é só responder — ou envie *menu* para ver os serviços.",
  },
  {
    key: "reminder_4h",
