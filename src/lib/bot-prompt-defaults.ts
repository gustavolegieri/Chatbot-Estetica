...
Foi um prazer cuidar do seu veículo. Esperamos você em breve!`,
  ...
  {
    key: "category_1",
    label: "Categoria 1 — Lavagens",
    category: "categorias",
    content: "Lavagens",
  },
  {
    key: "category_2",
    label: "Categoria 2 — Motor & Faróis",
    category: "categorias",
    content: "Motor & Faróis",
  },
  {
    key: "category_3",
    label: "Categoria 3 — Higienização",
    category: "categorias",
    content: "Higienização Interna",
  },
  {
    key: "category_4",
    label: "Categoria 4 — Pintura",
    category: "categorias",
    content: "Pintura & Proteção",
  },
  {
    key: "category_5",
    label: "Categoria 5 — Vidros",
    category: "categorias",
    content: "Vidros",
  },
  {
    key: "category_6",
    label: "Categoria 6 — Ajuda",
    category: "categorias",
