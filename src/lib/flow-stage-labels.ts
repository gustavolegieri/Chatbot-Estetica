...
export const FLOW_STAGE_LABELS: Record<string, string> = {
  ...
  ETAPA10_LOGISTICS: "Logística do veículo",
  ETAPA14_REMINDER: "Preferência de lembrete",
  ETAPA15_SUMMARY_CONFIRM: "Revisão do agendamento",
  ETAPA16_CONFIRMATION: "Agendamento confirmado",
