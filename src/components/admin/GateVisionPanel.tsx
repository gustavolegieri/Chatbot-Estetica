...
export function GateVisionPanel() {
  ...
  return <div className="pb-24 lg:pb-8">
    ...
    <Panel className="mb-6">
      <PanelTitle icon={ScanLine} title="Fluxo oficial da garagem" subtitle="Uma única risca representa o portão: cruzou para dentro, inicia; cruzou para fora, finaliza." />
